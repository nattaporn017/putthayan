            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div style="color:gray">
                        <i class="fas fa-chevron-right"></i>&nbsp;แก้ไขหลักสูตร
                    </div>
                    <!-- Topbar Navbar -->
            ...
            <div class="col-7" style="background-color:rgb(255,235,205);  ">
                <div style="padding: 40px;">
                    <div class="card" style="color: black;">
                        <div class="card-body">
                            <h5 class="card-title" style="text-align: center;"><i class="fas fa-book-medical"></i> แก้ไขหลักสูตร</h5>
                            <hr>
                            <p>สถานะหลักสูตร :
                                <?php
                            ...
                            <form method="post" enctype="multipart/form-data">
                                <div class=" input-group">
                                    ...
                                    <input type="text" class="form-control" name="course_id" value="<?php echo $result['course_id']; ?>" title="ไม่อนุญาติให้แก้ไข" readonly>
                                </div><br>
                                <div class=" input-group">
                                    <span style="background-color: #DCDCDC; color:black" for="course_name" class="input-group-text">
                                        ชื่อหลักสูตร :
                                    </span>
                                    <input type="text" class="form-control" name="course_name" value="<?php echo $result['course_name']; ?>" required>
                                </div><br>
                                <div class=" input-group">
                                    <span style="background-color: #DCDCDC; color:black" for="course_institution" class="input-group-text">
                                        หน่วยงานที่ดูแล :
                                    </span>
                                    <input type="text" class="form-control" name="course_institution" value="<?php echo $result['course_institution']; ?>" required>
                                </div><br>
                                <div class="input-group">
                                    <span for="course_detail">รายละเอียด :</span>
                                    <input type="text" class="form-control" name="course_detail" value="<?php echo $result['course_detail']; ?>" style="height: 100px; width: 1000px;" required>
                                </div><br>
...
<script>
    ...
    if (course_id.trim() === '' || course_name.trim() === '' || course_institution.trim() === '' ||
        ...
        Swal.fire({
            text: 'โปรดยืนยันการแก้ไขหลักสูตร',
            icon: 'warning',
            backdrop: 'static',
...
<?php
    ...
    chackForH($conn);
    include '../functionsHdb/CourseUdb.php'
?>