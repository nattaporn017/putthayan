...
<body id="page-top">
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-7" style="background-color:rgb(255,235,205);  ">
                <div style="padding: 40px;">
                    <div class="card" style="color: black;">
                        <div class="card-body">
                            <h5 class="card-title" style="text-align: center;"><i class="fas fa-book-medical"></i> เพิ่มหลักสูตร</h5>
                            <hr>
                            <label style="color:red; font-size: small;">* โปรดกรอกข้อมูลให้ครบทุกช่อง</label><br>
                            <form method="post" enctype="multipart/form-data">
                                <div class=" input-group">
                                    <span style="background-color: #DCDCDC; color:black" for="course_id" class="input-group-text">
                                        <div style="color:red; font-size: small;">*</div>รหัสหลักสูตร :
                                    </span>
                                    <input type="text" class="form-control" name="course_id" required>
                                </div><br>
                                <div class=" input-group">
                                    <span style="background-color: #DCDCDC; color:black" for="course_name" class="input-group-text">
                                        <div style="color:red; font-size: small;">*</div>ชื่อหลักสูตร :
                                    </span>
                                    <input type="text" class="form-control" name="course_name" required>
                                </div><br>
                                <div class=" input-group">
                                    <span style="background-color: #DCDCDC; color:black" for="course_institution" class="input-group-text">
                                        <div style="color:red; font-size: small;">*</div>หน่วยงานที่ดูแล :
                                    </span>
                                    <input type="text" class="form-control" name="course_institution" required>
                                </div><br>
                                <div class="input-group">
                                    <span for="course_detail"><label style="color: red;">*</label>รายละเอียด :</span>
                                    <input type="text" class="form-control" name="course_detail" style="height: 100px; width: 1000px;" required>
                                </div><br>
                                <div class="input-group">
                                        <span for="course_status">
                                            <lable style="color:red; font-size: small;">*</lable>สถานะหลักสูตร :
                                        </span><br>
                                        <div class="column5">
                                        </div>
                                        <div class="column20">
                                            <label><input type="radio" name="course_status" value="1" required>เปิดใช้งาน</label>
                                        </div>
                                        <div class="column20">
                                            <label><input type="radio" name="course_status" value="0" required>ปิดใช้งาน</label>
                                        </div>
                                    </div>
                                <div class="space box" align="right">
                                    ...
                                    <a href='../functionsH/courseR.php'><button type="button" class="btn btn-danger" style="padding: 10px 20px 10px 20px">ยกเลิก</button></a>
...
<script>
    function confCreate() {
        ...
        var course_name	 = document.querySelector('[name="course_name"]').value;
        var course_institution = document.querySelector('[name="course_institution"]').value;
        var course_detail = document.querySelector('[name="course_detail"]').value;
        var course_status	 = document.querySelector('input[name="course_status"]:checked');

        if (course_id.trim() === '' ||course_name.trim() === '' || course_institution.trim() === '' || 
            course_detail.trim() === '' || !course_status){
                Swal.fire({
            ...
            Swal.fire({
                text: 'โปรดยืนยันการบันทึกหลักสูตร',
                icon: 'warning',
                backdrop: 'static',
...
<?php 
    include '../functionsHdb/CourseCdb.php' ;
