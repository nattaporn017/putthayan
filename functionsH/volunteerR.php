<?php
session_start();
include "../functionsHdb/VolunteerRdb.php";
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div style="color:gray">
                        <i class="fas fa-chevron-right"></i>&nbsp;รายชื่ออาสากู้ภัย
                    </div>
                    <!-- Topbar Navbar -->
                            ...
                            <div class="row justify-content-center">
                                <div style="padding: 40px;">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <center>
                                                <h5 class="card-title"><i class="fas fa-user-tie"> </i> รายชื่ออาสากู้ภัย</h5><br>
                                            </center>
                                            <div class="gap-2 d-md-flex justify-content-md-end">
                                                <form class="d-flex" method="POST" action="../functionsH/SearchVdb.php" enctype="multipart/form-data">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control me-2" name="searchName" id="searchName" required>
                                                        <button class="btn btn-primary" type="submit">ค้นหา</button>
                                                    </div>
                                                    <!-- เพิ่มแถบสำหรับแสดงข้อความแจ้งเตือน -->
                                                    <div class="alert alert-danger mt-2" id="searchNameError" style="display:none;">
                                                        โปรดกรอกคำค้น
                                                    </div>
                                                </form>
                                            </div>
...
<script>
    document.querySelector('form').addEventListener('submit', function (event) {
        ...
        var searchNameError = document.getElementById('searchNameError');
        // ถ้าค่าใน input เป็นค่าว่าง แสดงข้อความแจ้งเตือนและยกเลิกการส่งฟอร์ม
